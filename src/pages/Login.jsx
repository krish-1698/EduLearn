       ...
       <MDBRow className="justify-content-center">
        ...
        <div style={{}}>
             ...
             <MDBCol className="justify-content-center" col="9">
              ...
              <h1 style={{textAlign:'center',color:'white',fontSize:'36px',fontWeight:'bolder'}}>EDULEARN</h1>
        ...
        <MDBCol col='4' md='6'>
          ...
          <div className="divider d-flex align-items-center my-4">
            ...
            <MDBRow className='d-flex justify-content-center'>
              ...
              <p className="small fw-bold mt-5 mr-3 pt-1 mb-2 justify-content-start text-dark" >Don't have an account? <a href="/Register" className="link-primary ml-2" style={{fontSize:"20px"}}>Register</a></p>
